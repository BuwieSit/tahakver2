...
export default function OurStory() {
    return (
        <div className="bg-background min-h-screen">
            ...
            {/* Hero Section */}
            <section className="relative py-32 md:py-48 px-6 md:px-10 overflow-hidden text-white">
                ...
                <div className="max-w-7xl mx-auto relative z-20 text-center">
                    <h1 className="text-2xl sm:text-3xl md:text-5xl font-primary-title mb-8 italic leading-tight max-w-4xl mx-auto drop-shadow-lg">
            ...
            <section className="py-16 md:py-24 px-6 md:px-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
                <div className="rounded-3xl overflow-hidden shadow-2xl aspect-video order-1 md:order-1">
                    <iframe 
                ...
                <div className="flex flex-col gap-4 md:gap-6 order-2 md:order-2">
                    <span className="text-primary font-bold uppercase tracking-widest text-xs md:text-sm">Our Essence</span>
                    <h2 className="text-3xl md:text-4xl font-primary-title text-accent leading-tight">What is TahaK?</h2>
                    <div className="space-y-4 text-sm md:text-base text-primary-text-color opacity-85 leading-relaxed font-primary-text">
                        <p>
            ...
            <section className="bg-white py-16 md:py-24 px-6 md:px-10">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
                    <div className="order-2 md:order-1">
                        <span className="text-primary font-bold uppercase tracking-widest text-xs md:text-sm">The Location</span>
                        <h2 className="text-3xl md:text-4xl font-primary-title text-accent mt-4 mb-6 leading-tight">A Sanctuary in Quezon</h2>
                        <p className="text-sm md:text-base text-primary-text-color opacity-80 mb-6 leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8 mt-10">
                            <div className="p-6 bg-background rounded-2xl">
                                <p className="text-2xl md:text-3xl font-bold text-primary">1st</p>
                                <p className="text-xs md:text-sm opacity-60">Wellness Operator in Quezon</p>
                            </div>
                            <div className="p-6 bg-background rounded-2xl">
                                <p className="text-2xl md:text-3xl font-bold text-primary">100%</p>
                                <p className="text-xs md:text-sm opacity-60">Nature Focused</p>
                            </div>
                        </div>
                    </div>
