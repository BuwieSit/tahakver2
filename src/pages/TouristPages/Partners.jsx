...
export default function Partners() {
    ...
    const PartnerCard = ({ partner }) => (
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-border flex flex-col items-center text-center transition-all hover:shadow-md">
            <div className="w-32 h-32 md:w-48 md:h-48 rounded-full mb-6 border-4 border-primary/20 bg-gray-50 overflow-hidden shrink-0">
                <img src={partner.img} alt={partner.name} className="w-full h-full object-cover" />
            </div>
            <h3 className="text-xl md:text-2xl font-bold text-accent mb-4">{partner.name}</h3>
            <p className="text-sm md:text-base text-primary-text-color opacity-80 leading-relaxed">{partner.desc}</p>
        </div>
    );
    ...
    return (
        <div className="min-h-screen bg-background">
            <Header />
            <main className="pt-24 md:pt-32 px-6 md:px-10 max-w-7xl mx-auto mb-16 md:mb-20">
                <section className="text-center mb-12 md:mb-16">
                    <h1 className="text-3xl md:text-5xl font-primary-title text-accent mb-4">Our Partners</h1>
                    <p className="text-base md:text-lg text-primary-text-color font-primary-text max-w-2xl mx-auto opacity-70">
                ...
                <section className="mb-12 md:mb-16">
                    <h2 className="text-2xl md:text-3xl font-bold text-accent mb-8 md:mb-10 text-center">Operations & Ecotourism Sites</h2>
                ...
                <section>
                    <h2 className="text-2xl md:text-3xl font-bold text-accent mb-8 md:mb-10 text-center">NGOs & Community Partners</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
